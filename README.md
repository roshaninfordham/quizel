...
QuizRush Live turns a room into a live multiplayer quiz race. The presenter runs `make online-public`, the projector shows a giant QR code, everyone joins from a phone, topic votes form a live swarm, AI agents generate and review seven rapid questions, and the arena shows every answer, score, rank jump, fixture movement, winner, and replay live.
...
5. The 5-second topic window closes automatically.
6. The Effect worker requests LLM questions and falls back to seed questions after 700ms if needed.
7. The match starts automatically and phones answer seven rapid questions inside one 25-second race clock.
8. Projector updates leaderboard and top-16 fixture lanes from committed state.
...
- Lock topics.
- The topic window, generation/fallback, and match start run automatically.
